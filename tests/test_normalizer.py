    ...
    def test_normalizes_estimate_text(self):
        ...
        self.assertEqual(
            normalize_estimate_text(text),
            {
                ...
                "surface_preparation": {"status": "not_stated", "evidence": None, "source": "rule", "confidence": 0.70, "review_required": True},
                "property_protection": {"status": "not_stated", "evidence": None, "source": "rule", "confidence": 0.70, "review_required": True},
                "trim_and_doors": {"status": "not_stated", "evidence": None, "source": "rule", "confidence": 0.70, "review_required": True},
                ...
                "lead_safety": {"status": "not_stated", "evidence": None, "source": "rule", "confidence": 0.70, "review_required": True},
